...
public class MainCameraScript2D : MonoBehaviour {
	...
	void Update () {
		...
		camPosBallX= ballObject.transform.position.x;
		...
		mainCamera.transform.position = new Vector3(camPosBallX, controlMidPointY, camPosLockZ);
